package com.frontlineed.teambitwise.activities.activitymodules.GetAllActivities;
...
public class GetAllActivitiesActivity implements IActivity {
    ...
    public void run()
    {
        ...
        Reflections reflections = new Reflections("com.frontlineed.teambitwise.activities");
